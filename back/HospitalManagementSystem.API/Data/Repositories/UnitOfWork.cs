...
namespace HospitalManagementSystem.API.Data.Repositories
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        private IGenericRepository<Radiology> _radiologies;
        private IGenericRepository<LabTestResult> _labtestresults;
        ...
        public IGenericRepository<LabTestResult> LabTestResults => _labtestresults ??= new GenericRepository<LabTestResult>(_context);
        ...
        public IGenericRepository<Radiology> Radiologies => _radiologies ??= new GenericRepository<Radiology>(_context);
